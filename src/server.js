...
- strategy_gate_whatif to verify a proposed rule against gate-audit history without touching the chart — the only verification available for an indicator(), which has no Strategy Tester`,
  },
);
